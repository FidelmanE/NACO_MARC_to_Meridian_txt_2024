# -*- coding: utf-8 -*-
"""DoNOTDELETE--By100aFinal.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Z4_IbQ_3nURH6UHyB6QnoulPll7fI3J9
"""
...
csv_out = csv.writer(open('/content/drive/My Drive/Data Services/NACOtoMeridianMapping/NACORecordsby100aEntityLabelRev20241209.csv', 'w'), delimiter = ',', quotechar = '"', quoting = csv.QUOTE_MINIMAL)
    ...
    for record in reader:
      ...
      try:
        ...
        for field in record.get_fields('670'):
          if record['670']:
            field670a = field.get_subfields('a')
            field670b = field.get_subfields('b')
            field670u = field.get_subfields('u')
            field670w = field.get_subfields('w')

            if field670a:
              field670as.extend([str(sf) for sf in field670a])
            else:
              field670as.append('No 670a')

            if field670b:
              field670bs.extend([str(sf) for sf in field670b])
            else:
              field670bs.append('No 670b')

            if field670u:
              field670us.extend([str(sf) for sf in field670u])
            else:
              field670us.append('No 670u')

            if field670w:
              field670ws.extend([str(sf) for sf in field670w])
            else:
              field670ws.append('No 670w')
          else:
            field670as.append('No 670')
            field670bs.append('No 670')
            field670us.append('No 670')
            field670ws.append('No 670')
        csv_out.writerow([field100a, field100c, field100q, field100d, field046f, field046g, field0462, field368c, field368d, field3682, field370a, field370b, field370c, field370e, field3702, field378q, field373a, field3732, field374a, field3742, field024alist, field0242list, field670as, field670bs, field670us, field670ws, field400as, field400cs, field400qs, field400ds, field500a, field500c, field500q, field500d, field510a, field510b, field510w, field510i])
      except KeyError:
            print([field100a])
            pass